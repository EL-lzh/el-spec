...
```shell
$ npm install el-eslint-plugin eslint --save-dev
```
...
// .eslintrc.js
module.exports = {
  plugin: ['el-eslint-config'],
  rules: {
    'el-eslint-plugin/no-secret-info': 'error',
  },
};
```
...
// .eslintrc.js
module.exports = {
  extends: 'plugin:el-eslint-plugin/recommended',
};
```
