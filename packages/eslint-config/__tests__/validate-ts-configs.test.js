...
describe('Validate TS configs', () => {
  it('Validate el-eslint-config/typescript', async () => {
  ...
  it('Validate el-eslint-config/typescript/vue', async () => {
  ...
  it('Validate el-eslint-config/essential/typescript', async () => {
  ...
  it('Validate el-eslint-config/essential/typescript/react', async () => {
  ...
  it('Validate el-eslint-config/essential/typescript/vue', async () => {
  ...
  it('Validate el-eslint-config/typescript/node', async () => {
