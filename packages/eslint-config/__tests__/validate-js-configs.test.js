...
describe('Validate JS configs', () => {
  it('Validate el-eslint-config', async () => {
  ...
  it('Validate el-eslint-config/es5', async () => {
  ...
  it('Validate el-eslint-config/vue', async () => {
  ...
  it('Validate el-eslint-config/essential', async () => {
  ...
  it('Validate el-eslint-config/essential/es5', async () => {
  ...
  it('Validate el-eslint-config/essential/react', async () => {
  ...
  it('Validate el-eslint-config/essential/vue', async () => {
  ...
  it('Validate el-eslint-config/node', async () => {
